        ...
        <!-- 테이블 넣는곳 시작부분 ^^-------------------------------------------------------------------------------------------------------- -->
         ...
         <table width="1000px;" height=200px; align=center style="background:#E6E6E6; border-radius:10px 30px 50px 80px;margin:0 auto;">
            ...
            <tr height=60px align=right>
               <td align=right colspan=5 class=z>지불 금액:<input type=number class=c id="tot" value="${total}" readonly></td>
            </tr>
            </table>
            <br><br>
                <table width="1000px;" height="600px;" align="center" style="background:#E6E6E6; border-radius:10px 30px 50px 80px;margin:0 auto;"> 
                    <tr> 
                        ...
                        <td width="500px" id="orderInfo">
                            ...
                            &nbsp;<input type="text" class=textbox id="addrCode" size="5;">&nbsp;<input type="button" onclick="click()" class=btngo1 id="postCode" value="우편번호"><br><br>
                        ...
                        <td width="500px" id="postInfo">
                            ...
                            &nbsp;<input type="text" class=textbox id="addrCode1" size="5;">&nbsp;<input type="button" id="postCode2" class=btngo1 value="우편번호"><br><br>
    ...
    .on('click','#pay',function(){
       ...
       if($('#memberName').val()==""){
          ...
          if(a==false){
             ...
             console.log(addr);
             $(location).attr("href","pay_complete4?s_id="+$('#s_id').val()+"&addr="+addr+"&total="+$('#hi').val());
          }
       }
    })
