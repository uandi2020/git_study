...
<div id=toptop style='position:relative;float:left'>
  <nav class=title_nav>
    ...
    <nav style='margin-top:100px;margin-bottom:300px;width:1920px'>
		...
		<form action='main' method='get' id=frm>
            <h1>(주)은수와 승미에 가입해주셔서 감사합니다</h1>
                <div class=welcome align=center><br> [ ${memberName} ]님 환영합니다.</div>
                <div class=welcome align=center><input type=button id=btnGo1 class=btngo1 value="Main">  <input type=button id=btnGo2 class=btngo1 value="Login"></div>
                </form>
    	 <!-- 테이블 끝나는 시작부분 ^^-------------------------------------------------------------------------------------------------------- -->
    </nav>
...
$(document).ready(function(){
	alert("회원가입 이벤트로 적립금 1000원 받으셨습니다 고갱님 ^ㅇ^");
})
