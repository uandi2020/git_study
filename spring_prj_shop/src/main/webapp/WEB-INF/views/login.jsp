    ...
    <nav style='margin-top:150px;margin-bottom:400px;width:1920px'>
        <!-- 테이블 넣는곳 시작부분 ^^-------------------------------------------------------------------------------------------------------- -->
         <!-- 여기에 넣어주고 TABLE인 경우 style='margin:0 auto;' 넣어주면 가운데정렬됨 -->
                <form action='homes' method='post' id=frm>
                <table class=login_table align='center' valign='middle' style='margin:0 auto;'>
                    <tr><th colspan=3 class=log><h1>login</h1></th></tr>
                    <tr><td colspan=3><hr></td></tr>
                    <tr><td colspan=3 align=center><input type=text class=login_box placeholder="example@gmail.com" id=loginId name='ids' style='align:center'></td></tr>
                    <tr><td colspan=3 align=center><input type=password class=login_box placeholder="password" id=loginPw name='pwd' style='align:center'></td></tr>
                    <tr align=right  class=login_find><td colspan="3" align=center ><b class=lo><a href='login_idFind' style="color:black;font-style:italic; ">아이디찾기</a></b>  
                    <b class=lo><a href='login_pwFind' style="color:black;font-style:italic; ">비밀번호찾기</a></b>  <b class=lo><a href='join' style="color:black;font-style:italic; ">회원가입</a></b></td></tr>
                    <tr><td align=center colspan=3><input type=button value="로그인" id=btn class=login_button></td></tr>
                    <tr><td colspan=3><hr></td></tr>
                </table>
                </form>
        <!-- 테이블 끝나는 시작부분 ^^-------------------------------------------------------------------------------------------------------- -->
   ...
   .on('click','#btn',function(){
      if($('.login_box').val()==''){
         ...
         $.ajax({
            ...
            datatype:'text',
            url:'logins',
            data:{ids:$('#loginId').val(),pwd:$('#loginPw').val()},
