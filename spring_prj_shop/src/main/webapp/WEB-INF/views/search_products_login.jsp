                ...
                <div class=score_all>
                    <table class="tbl" align="center">
                        ...
                        <c:forEach items="${score}" var="s">
                           <tr id='${s.s_id}' onmouseover="this.style.background='grey'" onmouseout="this.style.background='white'" onclick="location.href ='product?s_id=${s.s_id}';">
                         ...
                         <tr>
                           <td style='float:center;' colspan=7>
                              ...
                              <a href="search_products?pageNum=${back}&search=${sea}">[이전]</a>
                              </c:if>
                              <ul class=pageNum>
                              <c:forEach items='${num}' var='n'>
                            <li><a href='search_products?pageNum=${n}&search=${sea}' id="${n}">${n}</a></li>
                            </c:forEach>
                            </ul>
                            <c:if test="${endno eq 1}">
                            <a href="search_products?pageNum=${nexts}&search=${sea}">[다음]</a>
                           </c:if>
                           </td>
                             </tr>                
                        </tbody>
