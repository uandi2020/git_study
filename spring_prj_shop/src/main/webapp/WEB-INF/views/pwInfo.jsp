    ...
    <nav style='margin-bottom:200px;width:1920px'>
        <!-- 테이블 넣는곳 시작부분 ^^-------------------------------------------------------------------------------------------------------- -->
         <!-- 여기에 넣어주고 TABLE인 경우 style='margin:0 auto;' 넣어주면 가운데정렬됨 -->
                <form action='home' id=frm>
                <table align=center class=u style='margin:0 auto;'>
                 <tr>
                     <td ><h1>회원님의 기존비밀번호가 이메일로 발급됩니다.</h1></td>
                 </tr>
                 <tr>
                     <td align=center><br>발급받으신 비밀번호로 로그인 후 마이페이지 > 회원정보 수정에서 비밀번호를 변경 후 이용해주세요.</td></tr>
                 <tr><td><br></td></tr>
                 <tr><td align=center class=ab>${member.member_name}님의 아이디는 ${member.m_id} 입니다</td></tr>
                 <tr><td align=center class=ab>${member.member_mail} 인증번호가 전송되었습니다.</td></tr>
                 <tr>
                     <td><br><input type=button id=btnGo1 class=btngo value="홈">  <input type=button id=btnGo2 class=btngo value="로그인"></td>
                 </tr>
             </table>
             </form>
        <!-- 테이블 끝나는 시작부분 ^^-------------------------------------------------------------------------------------------------------- -->
