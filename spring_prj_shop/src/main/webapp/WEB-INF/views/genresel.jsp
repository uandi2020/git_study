    ...
    <nav style='width:1920px'>
        <!-- 테이블 넣는곳 시작부분 ^^-------------------------------------------------------------------------------------------------------- -->
         <!-- 여기에 넣어주고 TABLE인 경우 style='margin:0 auto;' 넣어주면 가운데정렬됨 -->
                ...
                <div>
                    <div class=content_div>장르별dd</div>
                        ...
                        <c:forEach items="${genre}" var="s">
                         ...
                         <tr>
                           <td style='float:center;' colspan=7>
                              ...
                              <a href="genresel?pageNum=${back}&genre=${gen}">[이전]</a>
                              </c:if>
                              <ul class=pageNum>
                              <c:forEach items='${num}' var='n'>
                            <li><a href='genresel?pageNum=${n}&genre=${gen}' id="${n}">${n}</a></li>
                            </c:forEach>
                            </ul>
                            <c:if test="${endno eq 1}">
                            <a href="genresel?pageNum=${nexts}&genre=${gen}">[다음]</a>
                           </c:if>
                           </td>
                             </tr>                
                        </tbody>
